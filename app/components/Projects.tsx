const Projects = () => {
  const projects = [
    {
      title: 'PBS NewsHour Storymaker - Contractor',
      description:
    ...
    },
    {
      ...
      description:
        'Working on a large-scale micro front-end application using Apollo Federation, Single-Spa-React, TypeScript, Jest, CypressJs and much more.',
      technologies:
        'TypeScript, Apollo Federation, Single-Spa-React, React, AWS CDK, AWS',
    },
    {
      ...
      technologies:
        'TypeScript, Prisma, Tailwind, Remix, Fly.io, GitHub Actions',
    },
    {
      title: 'Graylog - Security',
      description:
        'Designing and developing new features with React/Typescript.',
